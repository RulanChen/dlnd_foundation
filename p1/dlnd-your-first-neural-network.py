...
# 
# #### Your answer below
# The training loss from the model is 0.063, and the validation loss from the model is 0.150, the model predict the data good, but it fails from 22 December to 26 december, I think the Christmas Day is a important reason. If we add more features for these days, the model can fit well.
